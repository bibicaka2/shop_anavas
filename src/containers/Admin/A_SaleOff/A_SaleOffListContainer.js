...
import { actDeleteToSaleOff, actFetchSaleOff } from '../../../actions/index';
...
import './../../../App.css';
class A_SaleOffListContainer extends Component {
    constructor(props) {
        super(props)
...
export default connect(null, mapDispatchToProps)(A_SaleOffListContainer);